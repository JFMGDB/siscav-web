        ...
        <Container maxWidth="lg">
            ...
            <Paper sx={{ p: 3, mb: 4 }}>
                ...
                <Typography variant="body2" color="text.secondary" paragraph>
                    O feed ao vivo em <strong>Monitoramento</strong> usa a configuração guardada em{' '}
                    <strong>Pré-visualização</strong> (USB ou URL na rede), armazenada neste browser.
                </Typography>
                <Stack spacing={1} sx={{ mb: 2 }}>
                    <Typography variant="body2">
                        <strong>Fonte:</strong>{' '}
                        {config.source === 'usb' ? 'USB / este dispositivo' : 'Câmara na rede (URL)'}
                    </Typography>
                    ...
                    {config.source === 'usb' && config.usbDeviceId && (
                        <Typography variant="body2" color="text.secondary">
                            Dispositivo USB selecionado (identificador guardado para este browser).
                        </Typography>
                    )}
                </Stack>
