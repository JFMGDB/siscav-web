 ...
 * Login Form Moderno
 * 
 * Refatoração com design moderno e instrucional:
 * - Visual mais limpo e contemporâneo
 * - Melhor feedback visual
 * - Design instrucional com descrição clara
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (errorMessage.includes('Credenciais inválidas')) {
        ...
        setError('Muitas tentativas de login. Aguarde 1 minuto antes de tentar novamente.');
