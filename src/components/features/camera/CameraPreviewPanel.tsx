...
export default function CameraPreviewPanel() {
    ...
    return (
        <Box>
            ...
            >
                <Tab label="USB / Este dispositivo" id="camera-tab-usb" aria-controls="camera-panel-usb" />
                <Tab
            ...
            <Box role="tabpanel" hidden={tab !== 0} id="camera-panel-usb" aria-labelledby="camera-tab-usb">
