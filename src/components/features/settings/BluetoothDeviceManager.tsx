...
export default function BluetoothDeviceManager() {
    ...
    const registerDeviceWithBackend = async (device: BluetoothDevice) => {
        try {
            await apiClient.connectDevice(device.id);
    ...
    const handleDeviceDisconnected = () => {
        showMessage(`Dispositivo ${connectedDevice?.name} foi desconectado`, 'warning');
        handleDisconnect();
    };
    ...
    const handleDisconnect = async () => {
        ...
        try {
            ...
            // Remover listener
            connectedDevice.device.removeEventListener('gattserverdisconnected', handleDeviceDisconnected);
    ...
    return (
        <Paper sx={{ p: 4, maxWidth: 1000, mx: 'auto' }}>
            ...
            <Typography variant="body2" color="textSecondary" paragraph>
                Conecte um smartphone ou câmera via Bluetooth para captura de imagens de veículos.
            </Typography>
            ...
            {!isBluetoothSupported && (
                <Alert severity="error" sx={{ mb: 3 }}>
                    <strong>Navegador Incompatível:</strong> Web Bluetooth API não está disponível.
                    <br />Use Chrome, Edge ou Opera em um sistema com Bluetooth.
                </Alert>
            )}
                ...
                <Box sx={{ mt: 3, p: 2, bgcolor: 'grey.100', borderRadius: 1 }}>
                    ...
                    <Table size="small">
                        <TableBody>
                            ...
                            <TableRow>
                                <TableCell><strong>Status GATT:</strong></TableCell>
                                <TableCell>
                            ...
                            <TableRow>
                                <TableCell><strong>Stream de Vídeo:</strong></TableCell>
                                <TableCell>
                                    {videoStream ? (
